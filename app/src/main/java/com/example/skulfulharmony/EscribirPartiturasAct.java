...
public class EscribirPartiturasAct extends AppCompatActivity {
    ...
    private String[] notas = {"Do3", "Re3", "Mi3", "Fa3", "Sol3", "La3", "Si3", "Do4", "Re4", "Mi4", "Fa4"};
       ...
       // Referencia al EditText
        ...
        ivNota.post(new Runnable() {
            ...
            public void run() {
                ...
                coordenadasEsperadas.put("Do3", lineas[0].getY() +450);
                coordenadasEsperadas.put("Re3", espacios[0].getY()+450 );
                coordenadasEsperadas.put("Mi3", lineas[1].getY() +450);
                coordenadasEsperadas.put("Fa3", espacios[1].getY() +450);
                coordenadasEsperadas.put("Sol3", lineas[2].getY() +450);
                coordenadasEsperadas.put("La3", espacios[2].getY() +450);
                coordenadasEsperadas.put("Si3", lineas[3].getY() +450);
                coordenadasEsperadas.put("Do4", espacios[3].getY() +450);
                coordenadasEsperadas.put("Re4", lineas[4].getY() +450);
                coordenadasEsperadas.put("Mi4", espacios[4].getY() +450);
                coordenadasEsperadas.put("Fa4", lineas[5].getY() +450);
