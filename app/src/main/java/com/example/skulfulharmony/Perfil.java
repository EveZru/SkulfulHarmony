...
public class Perfil extends AppCompatActivity {
    ...
    private ImageView ivProfilePicture,iv_configuracion;
    private TextView tv_NombreUsuario, tv_No_Cursos,tv_DescripcionUsuario;
    private Button btnEditarPerfil, btnCerrarSesion, btnEliminarCuenta,btn_configuracion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ir a configuracion del perfi
        iv_configuracion=findViewById(R.id.iv_gotoconfiguracion);
        //barra de navegacion
        ...
        iv_configuracion.setOnClickListener(v -> {
