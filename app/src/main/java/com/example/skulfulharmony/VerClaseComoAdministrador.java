...
public class VerClaseComoAdministrador extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // Botón desestimar
            btnDesestimar.setOnClickListener(v -> {
                ...
                Button btnConfirmarDesestimar = dialogView.findViewById(R.id.btn_desestimar_dialog_desestimar);

                // Acción Cancelar: cerrar el diálogo
                btnCancelar.setOnClickListener(view -> dialog.dismiss());

                // Acción Desestimar: eliminar la denuncia
                btnConfirmarDesestimar.setOnClickListener(view -> {
                    if (docDenuncia != null) {
